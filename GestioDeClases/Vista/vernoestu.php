                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input name="P_50" type="number" min="0" class="form-control" placeholder="P_50"required />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="form-line">
                                            <input name="S_50" type="number" min="0" class="form-control" placeholder="S_50"required />
                                        </div>
                                    </div>
