...
<section style="margin-top: -380px" class="content">
    <div class="container-fluid">
        <form class="col s12" method="post" action="../Controlador/EstudiantesCtlr.php?action=actualizar">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="Nombre" name="Nombre" type="text" value="<?php echo $_SESSION['name']  ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Apellido</label>
                                            <input id="Apellido" name="Apellido" type="text" value="<?php echo $_SESSION['app']  ?>" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group label-floating">
                                            <select id="TipoDoc" name="TipoDoc" class="form-control show-tick">
                                                ...
                                                <?php if($_SESSION['TipoDoc']=="C.C"){?>
                                                    <option value="T.I">T.I</option>
                                                    <option SELECTED value="C:C"><?php echo $_SESSION['TipoDoc']?></option>
                                                    <option value="C.E">C.E</option>

                                                <?php } else if($_SESSION['TipoDoc']=="T.I"){?>
                                                    <option selected value="T.I"><?php echo $_SESSION['TipoDoc']?></option>
                                                    <option  value="C:C">C.C</option>
                                                    <option value="C.E">C.E</option>

                                                <?php } else if($_SESSION['TipoDoc']=="C.E"){?>
                                                    <option value="T.I">T.I</option>
                                                    <option  value="C:C">C.C</option>
                                                    <option selected value="C.E"><?php echo $_SESSION['TipoDoc']?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="Doc" name="Doc" type="number" value="<?php echo $_SESSION['Doc']  ?>" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Telefono</label>
                                            <input id="Tel" name="Tel" type="number" value="<?php echo $_SESSION['Tel']  ?>"class="form-control" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="email" name="email" type="email" value="<?php echo $_SESSION['email']  ?>" class="form-control" >
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        ...
                        <div class="content">
                            ...
                            <input type="file" dirname="foto" id="foto" name="foto" />



                            <input  style="margin-left: 10px; width: 90%;" id="fecha" name="fecha" type="text" class="datepicker form-control" value="<?php echo $_SESSION['fecha']  ?>"placeholder="Fecha de Inicio ">
...
<script>
    document.getElementById('vista_previa').innerHTML = '<img src="<?php echo $_SESSION['foto']  ?>" alt="" width="250" />';
